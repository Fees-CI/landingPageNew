...
//           <p className="w-[85%] text-center text-[60px] font-extrabold"> Digital Truth Transforming Africa’s Agricultural  Future</p>
...
export default function HeroSection() {
  ...
  return (
    <section className="px-14 py-2.5 bg-white w-full h-screen overflow-hidden">
      ...
      <div className="grid grid-cols-12 grid-rows-12 h-full">
        ...
        <div className="row-start-2 row-span-3 col-start-1 col-span-12 flex flex-col  gap-3 items-center justify-start text-[#2C2C2C]">
          <p className="w-[85%] text-center text-[60px] font-extrabold"> Digital Truth Transforming Africa’s Agricultural  Future</p>
          <p className="w-[50%] text-center text-lg font-light">We create eco responsible transparency empowering consumers to trust origins and support sustainable African agricultural innovation.</p>
        </div>
        <div className="row-start-6 row-span-7 col-start-1 col-span-12 ">
          <div className="w-full h-full grid grid-cols-11 grid-rows-5">
            <div className="mt-5 flex justify-center p-5 col-start-5 col-span-3 row-start-1 ">
                <div className="flex gap-2 pb-4">
                  <a href="" className="w-30 h-12 bg-[#03842B]  rounded-full flex justify-center items-center gap-2">
                    <p className="text-white text-[16px] font-normal">Book a Demo</p> 
                  </a>
                  <button className="inline-flex items-center justify-center gap-2 p-4 w-42 h-12 bg-[#ECFFF2] rounded-full">
                    <RxPlay className="text-gray-900 text-lg" />
                    <span className="text-gray-900 text-[16px] font-normal">
                      Watch a Demo
                    </span>
  ...
  {/* CHANGEMENTS ICI :
      1. 'inset-0' : Étend la div sur toute la surface de l'image.
      2. 'justify-between' : Pousse le premier élément (texte) vers le haut et le dernier (bouton) vers le bas.
  */}
  <div className="absolute inset-0 p-4 flex flex-col justify-between z-10">
    
    {/* Partie Texte */}
    <div className="self-end text-left"> 
        <p className="text-[64px] font-bold text-white">87%</p>
    ...
    {/* Partie Bouton */}
    {/* J'ai ajouté w-fit pour que le bouton ne prenne pas toute la largeur si ce n'est pas voulu */}
    <button
      className="
        w-fit
        backdrop-blur-sm bg-white/20
